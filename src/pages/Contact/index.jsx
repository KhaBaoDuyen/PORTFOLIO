...
export default function Contact() {
    ...
    return (
        <div className="flex w-full box-content flex-col 
        lg:mt-[5rem] mt-[3rem] items-center justify-center">
            <span className=" ">
                <h1 className="lg:text-5xl text-center text-3xl font-bold">Liên Hệ</h1>
                <p className="text-gray-300 mt-3 text-center">
                    Rất vui được kết nối và hợp tác cùng bạn. Hãy gửi tin nhắn cho tôi nhé!
                </p>

                <span className=" w-full box-content">
                    <motion.div
                        initial={{ opacity: 0, y: 300 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: false }}
                        transition={{ duration: 0.8, ease: "easeOut" }}
                        className="bg-white/30 p-3 w-full lg:mt-[3rem] mt-[1rem] lg:container rounded-2xl">
                        <div className="bg-black/70 relative backdrop-blur-lg rounded-2xl overflow-hidden 
                shadow-inner lg:py-10 py-5 px-5 lg:px-20 grid lg:grid-cols-2 gap-10">
