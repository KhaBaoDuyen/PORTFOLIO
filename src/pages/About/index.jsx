...
export default function About() {
    ...
    return <div>
        ...
        <section className="lg:p-6 !min-w-[20rem] mt-5  lg:container overflow-hidden mx-auto 
        grid lg:grid-cols-3 grid-cols-1 gap-6 items-center justify-items-center">
            <div className="space-y-5 w-full">
                <motion.div
                    ...
                    className="p-6 min-w-[20rem] bg-transparent rounded-2xl shadow-inner
            ...
            before:hover:h-44 before:hover:rounded-b-2xl
             ...
             before:w-80 before:h-24 before:rounded-t-2xl before:bg-gradient-to-bl
              ...
              before:top-0 w-80 h-72 relative bg-transparent border-2 border-white/30 flex flex-col 
              items-center justify-center gap-2 text-center rounded-2xl overflow-hidden">
                <div className="w-28 h-28 bg-pink-700 mt-8 rounded-full border-4 overflow-hidden border-pink-300 z-10 group-hover:scale-150 group-hover:-translate-x-24  group-hover:-translate-y-20 transition-all duration-500">
                    <img
        ...
        <section className="!mx-auto p-5 custom-section mt-[3rem] min-w-[20rem] min-h-screen relative ">
            <motion.div
        ...
        <section className="!mx-auto p-5 custom-section mt-[2rem] min-w-[20rem] relative ">
            <motion.div
                initial={{ opacity: 0, y: 300 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: false }}
